...
import 'package:menuray_merchant/features/publish/presentation/preview_menu_screen.dart';
...
void main() {
  testWidgets('PreviewMenuScreen renders title and menu data from provider',
      (tester) async {
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: zhMaterialApp(
          home: const PreviewMenuScreen(menuId: 'm1'),
        ),
      ),
    );
