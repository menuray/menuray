...
class _FakeMenuRepository implements MenuRepository {
        ...
        categories: const [
          DishCategory(
            ...
            dishes: [
              ...
              Dish(id: 'd_mp', name: '麻婆豆腐', price: 32),
            ],
          ),
        ],
      );
  ...
  Future<void> reorderDishes(
    List<({String dishId, int position})> pairs,
  ) async {}
...
void main() {
  testWidgets('OrganizeMenuScreen renders category and dishes from provider',
      (tester) async {
    ...
    expect(find.text('热菜'), findsOneWidget);
